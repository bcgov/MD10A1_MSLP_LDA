  ...
  png("Manuscript/tatolatex/Figures/Fall/sdoff_scree.png")
  ...
  png("Manuscript/tatolatex/Figures/Fall/elbow_plot.png")
  ...
  jpeg("Manuscript/tatolatex/Figures/Fall/cluster1_mean.jpeg", quality =100)
  ...
  jpeg("Manuscript/tatolatex/Figures/Fall/sdoff_pc1.jpeg", quality = 100)
  plot(pc1_ld, main="PC1", xlab="Easting", ylab = "Northing",col=cols)
  plot(ecoprov, add=TRUE)
  plot(bc_boun, add=TRUE)
  dev.off()
  jpeg("Manuscript/tatolatex/Figures/Fall/sdoff_pc2.jpeg",quality = 100)
  plot(pc2_ld, main="PC2", xlab="Easting", ylab = "Northing",col=cols)
  plot(ecoprov, add=TRUE)
  plot(bc_boun, add=TRUE)
  dev.off()
  jpeg("Manuscript/tatolatex/Figures/Fall/sdoff_pc3.jpeg",quality = 100)
  plot(pc3_ld, main="PC3", xlab="Easting", ylab = "Northing",col=cols)
  plot(ecoprov, add=TRUE)
  plot(bc_boun, add=TRUE)
  dev.off()
  jpeg("Manuscript/tatolatex/Figures/Fall/sdoff_pc4.jpeg",quality = 100)
  ...
  #View stepwise model selection results in console
  best_mod
  best_mod_scr
  ...
  png("Manuscript/tatolatex/Figures/Fall/scoreplot.jpeg")
  plot(lda_model, main = "LDA Score Plot")
  dev.off()
  
  #Get raw and standardized LDA coef. using candisc package, *!Must manually enter model params! 
  x=lm(cbind(PC1,PC4,PC6,PC10,PC13,PC14)~y_clust, reg_tab)
  ...
  plot(Can2~Can1, data = as.data.frame(coef_std), xlab = "LD1 Coefficient", ylab="LD2 Coefficient", main="LDA Loading Plot")
  ...
  jpeg("Manuscript/tatolatex/Figures/Fall/mslp_pc1.jpeg",quality = 100)
  plot(loading_lst[[1]], main = "MSLP PC1",xlab = 'Longitude',ylab='Latitude', box=FALSE,col = cols,xlim=c(-180,180), ylim=c(-90,90), asp=2)
  plot(coastlines, add=TRUE)
  dev.off()
  
  jpeg("Manuscript/tatolatex/Figures/Fall/mslp_pc4.jpeg", quality = 100)
  plot(loading_lst[[2]], main = "MSLP PC4",xlab = 'Longitude',ylab='Latitude', box=FALSE,col = cols,xlim=c(-180,180), ylim=c(-90,90), asp=2)
  plot(coastlines, add=TRUE)
  dev.off()
  
  jpeg("Manuscript/tatolatex/Figures/Fall/mslp_pc6.jpeg", quality = 100)
  plot(loading_lst[[3]], main = "MSLP PC6",xlab = 'Longitude',ylab='Latitude', box=FALSE,col = cols,xlim=c(-180,180), ylim=c(-90,90), asp=2)
  plot(coastlines, add=TRUE)
  dev.off()
  
  jpeg("Manuscript/tatolatex/Figures/Fall/mslp_pc10.jpeg", quality = 100)
  plot(loading_lst[[4]], main = "MSLP PC10",xlab = 'Longitude',ylab='Latitude', box=FALSE,col = cols,xlim=c(-180,180), ylim=c(-90,90), asp=2)
  plot(coastlines, add=TRUE)
  dev.off()
  
  jpeg("Manuscript/tatolatex/Figures/Fall/mslp_pc13.jpeg", quality = 100)
  plot(loading_lst[[5]], main = "MSLP PC13",xlab = 'Longitude',ylab='Latitude', box=FALSE,col = cols,xlim=c(-180,180), ylim=c(-90,90), asp=2)
  plot(coastlines, add=TRUE)
  dev.off()
  
  jpeg("Manuscript/tatolatex/Figures/Fall/mslp_pc14.jpeg", quality = 100)
