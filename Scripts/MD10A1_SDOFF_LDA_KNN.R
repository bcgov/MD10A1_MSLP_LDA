    ...
    # hm<-raster::reclassify(clu_1_dif, c(-Inf, -55, -56,
    #                                 -55, -34, -45, 
    #                                 -34, -21, -28,
    #                                 -21,-13,-17,
    #                                 -13,-8,-11,
    ...
    plot(clu_1_dif, breaks = c(-55,-34,-21,-13,-8,-5,0,5,8,13,21,34,55),col = hcl.colors(12,"Tofino"), main = "Cluster 1", xlab = "Easting", ylab = "Northing")
    plot(ecoprov, add=TRUE)
    plot(bc_boun, add=TRUE)
    dev.off()
    jpeg("Manuscript/tatolatex/Figures/KNN/cluster2_mean.jpeg", quality =100)
    plot(clu_2_dif, breaks = c(-55,-34,-21,-13,-8,-5,0,5,8,13,21,34,55),col = hcl.colors(12,"Tofino"), main = "Cluster 2", xlab = "Easting", ylab = "Northing")
    plot(ecoprov, add=TRUE)
    dev.off()
    jpeg("Manuscript/tatolatex/Figures/KNN/cluster3_mean.jpeg", quality =100)
    plot(clu_3_dif, breaks = c(-55,-34,-21,-13,-8,-5,0,5,8,13,21,34,55),col = hcl.colors(12,"Tofino"), main = "Cluster 3", xlab = "Easting", ylab = "Northing")
    plot(ecoprov, add=TRUE)
    dev.off()
